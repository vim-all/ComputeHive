...
func (x *OutputArtifact) GetRelativePath() string {
	if x != nil {
...
func (x *OutputArtifact) GetObjectKey() string {
	if x != nil {
		return x.ObjectKey
	}
	return ""
...
func (x *OutputArtifact) GetApiUrl() string {
	if x != nil {
		return x.ApiUrl
	}
	return ""
...
func (x *OutputArtifact) GetPublicUrl() string {
	if x != nil {
		return x.PublicUrl
	}
	return ""
...
func (x *OutputArtifact) GetSha256() string {
	if x != nil {
		return x.Sha256
	}
	return ""
...
func (x *OutputArtifact) GetSizeBytes() int64 {
	if x != nil {
		return x.SizeBytes
	}
	return 0
...
func (x *OutputArtifact) GetContentType() string {
	if x != nil {
...
type Job struct {
	...
	MaxRuntimeSeconds int32                  `protobuf:"varint,8,opt,name=max_runtime_seconds,json=maxRuntimeSeconds,proto3" json:"max_runtime_seconds,omitempty"`
...
func (x *Job) GetMaxRuntimeSeconds() int32 {
	if x != nil {
...
func (x *Job) GetArtifactUrl() string {
	if x != nil {
...
func (x *Job) GetArtifactSha256() string {
	if x != nil {
...
type Result struct {
	...
	OutputArtifacts []*OutputArtifact      `protobuf:"bytes,8,rep,name=output_artifacts,json=outputArtifacts,proto3" json:"output_artifacts,omitempty"`
	OutputApiUrl    string                 `protobuf:"bytes,9,opt,name=output_api_url,json=outputApiUrl,proto3" json:"output_api_url,omitempty"`
	OutputPublicUrl string                 `protobuf:"bytes,10,opt,name=output_public_url,json=outputPublicUrl,proto3" json:"output_public_url,omitempty"`
...
func (x *Result) GetOutputArtifacts() []*OutputArtifact {
	if x != nil {
...
func (x *Result) GetOutputApiUrl() string {
	if x != nil {
		return x.OutputApiUrl
	}
	return ""
}

func (x *Result) GetOutputPublicUrl() string {
	if x != nil {
		return x.OutputPublicUrl
	}
	return ""
}

func (x *Result) GetOutputSizeBytes() int64 {
	if x != nil {
...
const file_worker_proto_rawDesc = "" +
	...
	"\texit_code\x18\x04 \x01(\x05R\bexitCode\"\xf8\x01\n" +
	"\x0eOutputArtifact\x12#\n" +
	"\rrelative_path\x18\x01 \x01(\tR\frelativePath\x12\x1d\n" +
	"\n" +
	"object_key\x18\x02 \x01(\tR\tobjectKey\x12\x10\n" +
	"\x03uri\x18\x03 \x01(\tR\x03uri\x12\x17\n" +
	"\aapi_url\x18\x04 \x01(\tR\x06apiUrl\x12\x1d\n" +
	"\n" +
	"public_url\x18\x05 \x01(\tR\tpublicUrl\x12\x16\n" +
	"\x06sha256\x18\x06 \x01(\tR\x06sha256\x12\x1d\n" +
	"\n" +
	"size_bytes\x18\a \x01(\x03R\tsizeBytes\x12!\n" +
	"\fcontent_type\x18\b \x01(\tR\vcontentType\"\x91\x01\n" +
	...
	"\tmemory_mb\x18\x03 \x01(\x05R\bmemoryMb\"\x8f\x04\n" +
	"\x03Job\x12(\n" +
	...
	"\x0fcreated_at_unix\x18\x06 \x01(\x03R\rcreatedAtUnix\x12B\n" +
	"\venvironment\x18\a \x03(\v2 .compute.v1.Job.EnvironmentEntryR\venvironment\x12.\n" +
	"\x13max_runtime_seconds\x18\b \x01(\x05R\x11maxRuntimeSeconds\x12!\n" +
	"\fartifact_url\x18\t \x01(\tR\vartifactUrl\x12'\n" +
	"\x0fartifact_sha256\x18\n" +
	" \x01(\tR\x0eartifactSha256\x1a>\n" +
	...
	"\x10finished_at_unix\x18\a \x01(\x03R\x0efinishedAtUnix\x12E\n" +
	"\x10output_artifacts\x18\b \x03(\v2\x1a.compute.v1.OutputArtifactR\x0foutputArtifacts\x12$\n" +
	"\x0eoutput_api_url\x18\t \x01(\tR\foutputApiUrl\x12*\n" +
	"\x11output_public_url\x18\n" +
	" \x01(\tR\x0foutputPublicUrl\x12*\n" +
	"\x11output_size_bytes\x18\v \x01(\x03R\x0foutputSizeBytes\"\xbb\x01\n" +
...
var file_worker_proto_goTypes = []any{
	...
	(*OutputArtifact)(nil),         // 8: compute.v1.OutputArtifact
	(*JobTimestamps)(nil),          // 9: compute.v1.JobTimestamps
	(*JobSchema)(nil),              // 10: compute.v1.JobSchema
	(*WorkerResources)(nil),        // 11: compute.v1.WorkerResources
	(*WorkerCurrentLoad)(nil),      // 12: compute.v1.WorkerCurrentLoad
	(*WorkerCapabilities)(nil),     // 13: compute.v1.WorkerCapabilities
	(*WorkerStats)(nil),            // 14: compute.v1.WorkerStats
	(*WorkerSchema)(nil),           // 15: compute.v1.WorkerSchema
	(*AssignmentSchema)(nil),       // 16: compute.v1.AssignmentSchema
	(*WorkerID)(nil),               // 17: compute.v1.WorkerID
	(*JobID)(nil),                  // 18: compute.v1.JobID
	(*ResourceSpec)(nil),           // 19: compute.v1.ResourceSpec
	(*Job)(nil),                    // 20: compute.v1.Job
	(*Result)(nil),                 // 21: compute.v1.Result
	(*RegisterWorkerRequest)(nil),  // 22: compute.v1.RegisterWorkerRequest
	(*RegisterWorkerResponse)(nil), // 23: compute.v1.RegisterWorkerResponse
	(*HeartbeatRequest)(nil),       // 24: compute.v1.HeartbeatRequest
	(*HeartbeatResponse)(nil),      // 25: compute.v1.HeartbeatResponse
	(*RequestJobRequest)(nil),      // 26: compute.v1.RequestJobRequest
	(*RequestJobResponse)(nil),     // 27: compute.v1.RequestJobResponse
	(*SubmitResultRequest)(nil),    // 28: compute.v1.SubmitResultRequest
	(*SubmitResultResponse)(nil),   // 29: compute.v1.SubmitResultResponse
	nil,                            // 30: compute.v1.Job.EnvironmentEntry
}
var file_worker_proto_depIdxs = []int32{
	...
	9,  // 6: compute.v1.JobSchema.timestamps:type_name -> compute.v1.JobTimestamps
	1,  // 7: compute.v1.WorkerSchema.status:type_name -> compute.v1.WorkerLifecycleStatus
	11, // 8: compute.v1.WorkerSchema.resources:type_name -> compute.v1.WorkerResources
	12, // 9: compute.v1.WorkerSchema.current_load:type_name -> compute.v1.WorkerCurrentLoad
	13, // 10: compute.v1.WorkerSchema.capabilities:type_name -> compute.v1.WorkerCapabilities
	14, // 11: compute.v1.WorkerSchema.stats:type_name -> compute.v1.WorkerStats
	2,  // 12: compute.v1.AssignmentSchema.status:type_name -> compute.v1.AssignmentLifecycleStatus
	18, // 13: compute.v1.Job.job_id:type_name -> compute.v1.JobID
	19, // 14: compute.v1.Job.required_resources:type_name -> compute.v1.ResourceSpec
	3,  // 15: compute.v1.Job.status:type_name -> compute.v1.Status
	30, // 16: compute.v1.Job.environment:type_name -> compute.v1.Job.EnvironmentEntry
	18, // 17: compute.v1.Result.job_id:type_name -> compute.v1.JobID
	3,  // 18: compute.v1.Result.status:type_name -> compute.v1.Status
	8,  // 19: compute.v1.Result.output_artifacts:type_name -> compute.v1.OutputArtifact
	19, // 20: compute.v1.RegisterWorkerRequest.available_resources:type_name -> compute.v1.ResourceSpec
	15, // 21: compute.v1.RegisterWorkerRequest.worker:type_name -> compute.v1.WorkerSchema
	17, // 22: compute.v1.RegisterWorkerResponse.worker_id:type_name -> compute.v1.WorkerID
	17, // 23: compute.v1.HeartbeatRequest.worker_id:type_name -> compute.v1.WorkerID
	19, // 24: compute.v1.HeartbeatRequest.available_resources:type_name -> compute.v1.ResourceSpec
	18, // 25: compute.v1.HeartbeatRequest.running_jobs:type_name -> compute.v1.JobID
	12, // 26: compute.v1.HeartbeatRequest.current_load:type_name -> compute.v1.WorkerCurrentLoad
	17, // 27: compute.v1.RequestJobRequest.worker_id:type_name -> compute.v1.WorkerID
	20, // 28: compute.v1.RequestJobResponse.job:type_name -> compute.v1.Job
	10, // 29: compute.v1.RequestJobResponse.job_schema:type_name -> compute.v1.JobSchema
	16, // 30: compute.v1.RequestJobResponse.assignment:type_name -> compute.v1.AssignmentSchema
	17, // 31: compute.v1.SubmitResultRequest.worker_id:type_name -> compute.v1.WorkerID
	21, // 32: compute.v1.SubmitResultRequest.result:type_name -> compute.v1.Result
	7,  // 33: compute.v1.SubmitResultRequest.result_schema:type_name -> compute.v1.JobResultSchema
	22, // 34: compute.v1.WorkerService.RegisterWorker:input_type -> compute.v1.RegisterWorkerRequest
	24, // 35: compute.v1.WorkerService.Heartbeat:input_type -> compute.v1.HeartbeatRequest
	26, // 36: compute.v1.WorkerService.RequestJob:input_type -> compute.v1.RequestJobRequest
	28, // 37: compute.v1.WorkerService.SubmitResult:input_type -> compute.v1.SubmitResultRequest
	23, // 38: compute.v1.WorkerService.RegisterWorker:output_type -> compute.v1.RegisterWorkerResponse
	25, // 39: compute.v1.WorkerService.Heartbeat:output_type -> compute.v1.HeartbeatResponse
	27, // 40: compute.v1.WorkerService.RequestJob:output_type -> compute.v1.RequestJobResponse
	29, // 41: compute.v1.WorkerService.SubmitResult:output_type -> compute.v1.SubmitResultResponse
